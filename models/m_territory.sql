...
LEFT OUTER JOIN (
	...
	FROM {{ var('schema') }}.territory_business
...
AND t.ID not in(
	select id from {{ var('schema') }}.territory_business where name like '%L4%Consumer%'
union
	select id from {{ var('schema') }}.territory_business where parentterritory2id in
		(select id from {{ var('schema') }}.territory_business where name like '%L4%Consumer%')
union
	select id from {{ var('schema') }}.territory_business where parentterritory2id in
		(select id from {{ var('schema') }}.territory_business where parentterritory2id in
