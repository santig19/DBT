...
case when (c.Call_Datetime_vod__c != '') then to_char(to_date(c.Call_Datetime_vod__c,'YYYYMMDD HH24:MI:SS'),'dd-mm-yyyy')::varchar(10) else '' end As Date,
case when (c.Call_Datetime_vod__c != '') then to_char(to_date(c.Call_Datetime_vod__c,'YYYYMMDD HH24:MI:SS'),'dd-mm-yyyy')::varchar(10) else '' end As Call_Date,
case when (c.Call_Datetime_vod__c != '') then to_char(to_timestamp(c.Call_Datetime_vod__c,'YYYYMMDD HH24:MI:SS'),'yyyy-mm-dd HH24:MI:SS')::varchar(19) else '' end As Call_Timestamp,
