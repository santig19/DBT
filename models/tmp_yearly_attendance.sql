...
SELECT 
    ...
    ,to_number(Aux_Annual_Promotional_Event_Attendee_Counter, 10 , 0) AS Aux_Annual_Promotional_Event_Attendee_Counter
    ,to_number(Aux_Annual_Medical_Event_Attendee_Counter, 10 , 0) AS Aux_Annual_Medical_Event_Attendee_Counter
