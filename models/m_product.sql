...
from {{ var('schema') }}.products_business root
left join {{ var('schema') }}.country_settings_business cs on cs.country_iso_code = root.country_iso_code
left join (
	select id as product_id, parent_product_vod__c as parent_product_id, name as product_topic, 'Topic' as product_type
	from {{ var('schema') }}.products_business
